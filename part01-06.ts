...
let LiteralAge: 20 | 30 | 40;
//LiteralAge = 24; // 에러 발생

// * 함수의 argument, return type으로도 사용 가능
function LiteralFunc(arg: "hello"): 1 | 0 {
    // return 100; // 에러발생
    return 1;
}
// LiteralFunc("world"); // 에러 발생

function RockPaperScissors(arg: "rock" | "paper" | "scissors"): ("rock" | "paper" | "scissors")[] {
    return ["rock"];
}
...
let mySelf: "Jay" | "Developer" | "Seoul";
// const newUser = mySelf;
// newUser = "Busan"; // 에러 발생
